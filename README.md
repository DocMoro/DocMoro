...
- :seedling: Стремлюсь стать ведущим специалистом по оптимизации веб-приложений.
- :pager: Мне интересно работать на современном стеке.
- :zap: Хочу чувствовать себя частью большой амбициозной команды.
- :mailbox: Связаться со мной: [andreymorogin@mail.ru]
